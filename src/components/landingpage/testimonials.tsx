    ...
    <>
      <section className="py-16 md:py-24 relative my-12 md:my-24 w-full lg:hidden flex flex-col items-center p-8 gap-8">
        <div className="flex flex-col">
          <h2 className="text-xl md:text-2xl text-gray-800 mb-2 md:mb-4 font-display text-center">
            Client Observations and Inference
          </h2>
          <p className="text-base md:text-lg text-gray-600 max-w-sm mx-auto text-center">
        ...
        <div className="w-full flex items-center gap-8 mx-auto">
          <div className="bg-white rounded-lg flex flex-col gap-4 items-center px-4 py-4 xl:py-16  border-2 border-gray-500 w-full min-h-[300px] sm:h-[324px] md:h-[300px] md:w-[45%]">
          ...
          <div className="bg-white rounded-lg flex-col gap-2 items-center px-4 py-4 xl:py-16  border-2 border-gray-500 w-full sm:h-[324px] md:h-[300px] md:w-[45%] hidden sm:flex">
            <div className="flex flex-col gap-2 items-center">
              <h3 className="text-xl md:text-2xl font-bold text-gray-800">
                Garima Goel
              </h3>
            ...
            <p
              className={`${montserrat.className} text-gray-700 w-[80%] !text-[13px] text-center`}
            >
      ...
      <section className="py-16 md:py-24 relative my-12 md:my-24 w-full hidden lg:block">
        ...
        <div className="mx-auto px-4 relative z-10">
          <div className="text-center mb-10 md:mb-16 flex flex-col md:flex-row items-start justify-center gap-3 md:gap-5 mx-auto max-w-4xl">
            <h2 className="text-xl md:text-2xl text-gray-800 mb-2 md:mb-4 max-w-xs font-display text-left">
              Client Observations and Inference
            </h2>
            <p className="text-base md:text-lg text-gray-600 max-w-sm mx-auto px-2 text-left">
              Hear from the brands that trusted our process and saw the results.
            </p>
          </div>
        </div>
        <div className="flex items-center gap-12 w-full">
          <div className="bg-white rounded-lg rounded-l-none p-6 md:p-8  border border-gray-500 w-[50px] xl:w-[130px] h-[450px]" />
          <div className="bg-white rounded-lg flex justify-between items-start px-4 py-4 xl:py-16  border border-gray-500 w-[800px] xl:!w-[700px] h-[450px]">
            ...
            <p
              className={`${montserrat.className} text-gray-700 w-[80%] !text-[13px]`}
            >
              Working with Dhruv was both strategic and seamless. He brought
              much-needed structure to our digital initiatives, was deeply
              involved in execution, and helped us achieve tangible results in a
          ...
          <div className="bg-white rounded-lg rounded-r-none p-6 md:p-8  border border-gray-500 w-[50px] xl:w-[130px] h-[450px]" />
        </div>
      </section>
    </>
  );
