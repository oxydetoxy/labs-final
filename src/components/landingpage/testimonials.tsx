  ...
  const testimonials = [
    {
      ...
      text: "Working with Dhruv was both strategic and seamless. He brought much-needed structure to our digital initiatives, was deeply involved in execution, and helped us achieve tangible results in a short period. Dhruv is a natural problem solver — he quickly identifies what's not working and proposes clear, actionable plans to move forward.",
    },
    {
      name: "Garima Goel",
      title: "Shades of India - Marketing Head",
      text: "Working with Dhruv is like being in a true partnership. During our engagement, he demonstrated remarkable expertise in both strategic planning and tactical execution that directly contributed to our business growth and helped us break the stagnant cycle we were stuck in.",
    },
  ];
    ...
    <>
      <section className="py-16 md:py-24 relative my-12 md:my-24 w-full lg:hidden flex flex-col items-center p-8 gap-8">
        <div className="flex flex-col">
          <h2 className="text-xl sm:text-2xl mb-2 md:mb-4 font-display text-center !text-[#54453E]">
          ...
          >
            {testimonials.map((testimonial, index) => (
              <div key={index} className="w-full flex-shrink-0 px-2">
                <div className="bg-white rounded-lg flex flex-col gap-4 items-center px-4 py-4 xl:py-16 border-2 border-[#54453E] w-full min-h-[300px] sm:h-[324px] md:h-[300px]">
          ...
          {testimonials.map((_, index) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-colors duration-200 ${
                index === currentSlide ? "bg-[#54453E]" : "bg-gray-300"
              }`}
            />
          ))}
        </div>
      ...
      <section className="py-16 md:py-24 relative my-12 md:my-24 w-full hidden lg:block">
        ...
        <div className="mx-auto px-4 relative z-10">
          <div className="text-center mb-10 md:mb-16 flex flex-col md:flex-row items-start justify-center gap-3 md:gap-5 mx-auto max-w-4xl">
            <h2 className="text-xl sm:text-2xl text-[#54453E] mb-2 md:mb-4 max-w-xs font-display text-left">
              Client Observations and Inference
            </h2>
