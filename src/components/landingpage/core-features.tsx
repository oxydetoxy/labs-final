      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-center mb-8 md:mb-12">
          <div className="lg:mb-0">
            <h2 className="font-display text-[40px] text-[#54453E] mb-4">
          ...
          <div className="max-w-sm px-1 flex flex-col items-start gap-4 mt-[20px]">
            <div className="text-gray-600 text-sm leading-relaxed">
              <p className="mb-1">This isn&apos;t a list of services.</p>
              <p className="mb-1">It&apos;s a set of controlled experiments</p>
              <p>designed to engineer real growth.</p>
            </div>
            <Link href="/services">
